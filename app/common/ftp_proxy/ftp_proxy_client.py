...
class FTPProxyClient:
    ...
    def list_files(self, path: str = "/") -> list[dict]:
        ...
        resp = httpx.get(f"{self.proxy_url}/v1/ftp-proxy/list", params=params)
    ...
    def download(self, remote_path: str, local_path: str) -> Path:
        ...
        with httpx.stream("GET", f"{self.proxy_url}/v1/ftp-proxy/download", params=params) as resp:
            resp.raise_for_status()
    ...
    def upload(self, local_path: str, remote_dir: str) -> dict:
        ...
        with open(local, "rb") as f:
            ...
            resp = httpx.post(f"{self.proxy_url}/v1/ftp-proxy/upload", params=params, files=files)
        resp.raise_for_status()
        return resp.json()
